...
<Steps>
  ...
  ### Fork Repository 
  Kunjungi project [GitHub Buku Kampus](https://github.com/fyydsz/webnotes) dan klik tombol "Fork" untuk
...
Jika kamu ingin **berkontribusi** namun enggan ngoding 😹😹😹 kamu bisa hubungi Fyy melalui [halaman ini](/docs/tentang).
